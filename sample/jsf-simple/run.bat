...
REM OK call mvn clean install jetty:run-war -Psample,run-its -Dserver=jetty9x -Ddatabase=derby -Djetty.port=9090 -Dwebdriver.base.url=http://localhost:9090 > deploy.log 2>&1
...
#-DSTOP.PORT=19097 -DSTOP.KEY=STOP
